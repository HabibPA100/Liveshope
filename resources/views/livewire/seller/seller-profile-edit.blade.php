<div class="max-w-2xl mx-auto p-4">
    ...
    <form wire:submit.prevent="updateProfile" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" wire:model.defer="store_name" class="w-full border rounded p-2" />
        ...
        <div>
            <label class="block mb-1 font-semibold">National ID</label>
            <input type="text" wire:model.defer="national_id" class="w-full border rounded p-2" />
            @error('national_id') <span class="text-red-600">{{ $message }}</span> @enderror
        </div>

        <div>
            <label class="block mb-1 font-semibold">Date of Birth</label>
            <input type="date" wire:model.defer="date_of_birth" class="w-full border rounded p-2" />
